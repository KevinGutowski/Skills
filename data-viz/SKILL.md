...
Typical flow: select the type first (chart-selection), then refine with the critique principles (tufte). For the *in-app experience* around a chart — platters, progressive disclosure, Swift Charts, Audio Graphs, accessibility labels — use `chart-experience-design` instead.
