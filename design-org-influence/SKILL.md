...
- **SBI (Situation–Behavior–Impact)** for every entry: "Checkout had a 34% drop-off at the payment step" → "I ran a 3-day research sprint… redesigned the form with inline validation" → drop-off at that step fell substantially after launch. Same work, completely different picture.
