...
Use this file for frontend-generation guidance that needs screenshots, assets, or accepted examples before becoming durable.
...
Candidate:
UI type:
Source or accepted generated example:
Evidence artifact:
Rule:
Check possible:
Exception:
