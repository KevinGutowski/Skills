...
- [Controller Patterns](#controller-patterns) - REST-pure design, concerns, complete examples
- [Model Patterns](#model-patterns) - Associations, scopes, custom methods, authorization, broadcasting
- [Current Attributes Pattern](#current-attributes-pattern) - Definition, setup, usage
- [Ruby Idioms](#ruby-idioms) - Guard clauses, case statements, method chaining
- [View Patterns](#view-patterns) - Helpers, Turbo Frames, Stimulus integration
- [Testing Patterns](#testing-patterns) - System tests, fixtures, integration tests
- [Configuration Patterns](#configuration-patterns) - Solid Queue, SQLite, Docker
- [Anti-Patterns to Avoid](#anti-patterns-to-avoid) - Service objects, policy objects, over-mocking
