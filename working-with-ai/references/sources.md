...
This source map keeps AI-tool guidance separated by task shape.
...
Promote new AI-workflow guidance only when it is tied to repeated local use, current tool behavior, a documented security/privacy concern, or an accepted organization rollout pattern. Tool names and capabilities decay quickly; date them when needed.
