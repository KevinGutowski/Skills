...
description: "Earn developer adoption and revenue for a developer tool — landing-page anatomy (hero → trust → features → social proof → final CTA; six hero visuals; storytelling ranked from feature lists to mission statements), the five conversion killers (vague language, invisible CTAs, first-screen distractions, enterprise gating, build-and-walk-away), devtool copywriting (banned clichés, numbers over adjectives), the six product qualities that earn trust, and the PMF Compass (signal-vs-revenue dual score, gap diagnosis, TTFV/retention/NRR benchmarks). Use when writing or reviewing a devtool landing page or copy, choosing CTAs, diagnosing weak conversion or adoption, assessing product-market fit, or prioritizing GTM vs product work. Based on five Evil Martians Chronicles posts. Triggers: devtool landing page, developer marketing, hero section, CTA, free-to-paid conversion, D7 retention, NRR, time to first value, PMF, devtool copy."
---
