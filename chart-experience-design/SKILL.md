...
**Sources:** [references/sources.md](references/sources.md) — 2 Apple WWDC 2022 design sessions + an MDS data-density critique.
...
- **`apple-design` (apple-visual-accessibility)** — the broader accessibility settings behind this skill's color and VoiceOver rules (Differentiate Without Color, contrast, Increase Contrast).
