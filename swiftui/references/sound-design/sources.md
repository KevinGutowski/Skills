...
This skill aggregates Hugo Verweij's (Apple Human Interface sound designer) two sessions:

- *Apple WWDC 2017, session 803 — "Designing Sound." https://developer.apple.com/videos/play/wwdc2017/803/*
- *Apple WWDC 2018, session 804 — "The Life of a Button" (the sound half; the interaction half lives in [../touch-interaction-design.md](../touch-interaction-design.md)). https://developer.apple.com/videos/play/wwdc2018/804/*
...
- *Rafa Conde — Dive Club interview (youtube.com/watch?v=3rnhlZj25iY): the motif-first multi-channel note.*
