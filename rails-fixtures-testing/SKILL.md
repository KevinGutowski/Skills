...
- `dhh-style` — the school doctrine this testing practice belongs to.
- `rails-testing` — the *factories* school (RSpec/FactoryBot, TestProf speed/flakiness method). Different schools — route by the project's existing choice, don't blend.
- `rails-security-multitenancy` — the tenancy architecture these test-wiring patterns exercise.
