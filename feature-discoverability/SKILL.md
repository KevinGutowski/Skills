...
- **`apple-design` (app-intents-design)** — the Siri Tip is this skill's pattern applied to shortcuts; same dismissibility ethic.
- **`apple-design` (apple-navigation-design)** — tab bars vs hidden menus is its structural domain; this skill supplies the *why* (discoverability testing).
