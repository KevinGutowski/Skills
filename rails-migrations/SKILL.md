...
- `dhh-style` — the vanilla-school doctrine these patterns assume (incl. database-per-tenant tenancy via Active Record Tenanted).
- `optimizing-rails` — runtime performance once the schema ships.
