...
*Scope: Write and organize settings IA/copy in a Linear-inspired style. Use when designing settings pages, subpages, sidebar taxonomy, section groupings, setting row titles, short helper descriptions, dropdown option labels, action labels, empty states, and account/workspace/team/integration settings copy.*

Use this skill when creating or revising product settings. It is grounded in a live audit of Linear settings surfaces, summarized in [linear-settings-copy/linear-settings-copy-ia.md](linear-settings-copy/linear-settings-copy-ia.md).
