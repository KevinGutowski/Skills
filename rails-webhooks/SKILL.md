...
- `dhh-style` — the vanilla-school doctrine these patterns assume.
- `rails-security-multitenancy` — full SSRF defense baseline referenced above.
- `rails-jobs` — Continuable fan-out, queue isolation, error taxonomy.
