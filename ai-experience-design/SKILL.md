...
description: "Design AI/ML-powered experiences — confidence as actions, attributions, calibration, corrections, plus prompting and safety for Apple's on-device model. Use when designing ML/LLM-backed features, presenting model confidence, designing correction flows, or writing Foundation Models prompts. Based on 2 Apple WWDC sessions. Triggers: AI feature UX, confidence display, attributions, calibration, Foundation Models, on-device LLM, hallucination."
---
