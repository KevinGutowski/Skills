...
- **`ai-enablement`** — rolling AI tooling out across an org: shared context, internal agents, social proof, and adoption programs. Use this skill to design the learning mechanics inside that rollout.
